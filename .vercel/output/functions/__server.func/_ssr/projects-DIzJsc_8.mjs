...
import { S as ArrowUpRight, T as Sparkles, c as ShieldCheck, d as Plane, h as Handshake, l as Radio, n as Trophy, p as MapPin, t as Zap, w as ArrowLeft, x as Building2 } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/projects-DIzJsc_8.js
...
var milestones = [
	...
	{
		year: "2024",
		title: "Regional Airport ICT & Low Current",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-3.5 w-3.5" }), "Back to Meridian"]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...fadeUp,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.p, {
						...
						children: "From the first smart ministry building to nationwide mobility, aviation and defense programs — every milestone in the Meridian archive is a system still running, every day, somewhere in the Kingdom."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...fadeUp,
						transition: {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "inline-flex items-center gap-2 rounded-full bg-emerald-700/90 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white",
									children: "Project spotlight"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-sm leading-relaxed text-white/80",
									children: "A force-multiplier for Meridian's intelligent infrastructure, mobility, and security programs."
								})]
							})
						]
					})
	...
	const featured = [
		{
			...
			desc: "A national fast-charging deployment, unified under one operations and billing layer.",
			img: svc_ev_default,
			tag: "Mobility"
		},
		{
			year: "2024",
			title: "Regional Airport ICT",
			desc: "End-to-end low-current and ICT backbone for a new regional aviation hub.",
			img: svc_iot_default,
			tag: "Aviation"
		},
		{
			year: "2023",
			title: "Airbase Security Suite",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "rounded-full bg-emerald-700/90 px-2.5 py-1 text-[10px] font-medium uppercase tracking-[0.18em] text-white",
									children: f.tag
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...
						className: "pointer-events-none absolute left-4 top-0 h-full w-px bg-gradient-to-b from-emerald-700 via-emerald-600 to-amber-500 md:left-1/2"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: filtered.map((m, i) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.li, {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "absolute left-4 top-6 grid h-3 w-3 -translate-x-1/2 place-items-center rounded-full bg-background ring-2 ring-emerald-700 md:left-1/2",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-700" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												m.tag && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "rounded-full bg-emerald-700/10 px-2.5 py-1 text-[10px] text-emerald-800",
													children: m.tag
												})
											]
										})
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					...
					children: partners.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.li, {
						...
						className: "group flex items-center justify-between bg-background p-6 transition-all hover:bg-emerald-50/50",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: ["Contact Meridian", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:rotate-45" })]
