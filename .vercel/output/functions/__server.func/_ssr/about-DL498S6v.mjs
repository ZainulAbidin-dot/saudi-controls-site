...
import { E as CircleCheck, S as ArrowUpRight, T as Sparkles, _ as Eye, a as Target, b as Compass, m as HeartHandshake, u as Quote, w as ArrowLeft } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/about-DL498S6v.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var about_founder_default = "/assets/about-founder-GKROh8l5.jpg";
var about_promise_default = "/assets/about-promise-KhTHc2UB.jpg";
var EASE = [
	.16,
	1,
	.3,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-3.5 w-3.5" }), "About Meridian"]
						})
					}),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.p, {
						...
						children: "Meridian was founded on a simple conviction: the control systems quietly running modern cities deserve the same rigor as the architecture above them. Our values are rooted in heritage and sharpened by an obsession with what comes next."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.p, {
						...fadeUp,
						transition: {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.blockquote, {
						...
						className: "mt-10 border-l-2 border-emerald-700/60 pl-5 font-display text-lg italic text-foreground/75",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: [
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mt-0.5 h-4 w-4 shrink-0 text-emerald-700" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: b })]
						}, b))
					})
				]
			})]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute left-[6.5rem] top-2 bottom-2 hidden w-px bg-foreground/15 md:block" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: milestones.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.li, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "font-display text-3xl italic text-emerald-800 md:text-4xl",
								children: m.y
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative md:pl-10",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -left-[1.05rem] top-3 hidden h-2.5 w-2.5 rounded-full bg-emerald-700 ring-4 ring-secondary md:block" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
...
function Pull() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quote, { className: "mx-auto h-10 w-10 text-emerald-700/70" }),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -right-24 -top-24 h-80 w-80 rounded-full bg-emerald-500/30 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -bottom-24 left-1/3 h-80 w-80 rounded-full bg-amber-400/20 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.h2, {
						...fadeUp,
						className: "relative max-w-3xl font-display text-4xl leading-[1.05] tracking-tight md:text-6xl",
						children: [
							"Curious how we'd approach",
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
